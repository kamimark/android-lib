...
/**
 * all textView that is able to self-adjust its font size depending on the min and max size of the
...
public class AutoResizeTextView extends AppCompatTextView
{
    ...
    {
        // This is all workaround for truncated text issue on ListView, as shown here: https://github.com/AndroidDeveloperLB/AutoFitTextView/pull/14
//    post(new Runnable()
//    {
//    @Override
//    public void run()
